...
def sendDiscord(message, buyType, sku, condition):
    ...
    if "curbside" in buyType:
        ...
        if condition in 'inventory':
            if sku in ('16380346', '11465449'): #adjustable-inventory
            ...
            if sku in ('16380346', '11465449'): #adjustable - 1
            ...
            if sku in ('16380346', '11465449'): #adjustable - 2
            ...
            if sku in ('16380346', '11465449'): #adjustable - 3
